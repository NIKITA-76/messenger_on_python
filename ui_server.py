...
class Ui_Server(object):
    def setupUi(self, MainWindow, ):
        ...
        self.lineEdit_cabinet = QtWidgets.QLineEdit(self.page_crt_usr)
        self.lineEdit_cabinet.setGeometry(QtCore.QRect(100, 175, 321, 36))
        ...
        self.label_сabinet = QtWidgets.QLabel(self.page_crt_usr)
        self.label_сabinet.setGeometry(QtCore.QRect(8, 180, 66, 19))
        self.label_сabinet.setAlignment(QtCore.Qt.AlignCenter)
        self.label_сabinet.setObjectName("label_сabinet")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_сabinet.setText(_translate("MainWindow", "Кабинет:"))
