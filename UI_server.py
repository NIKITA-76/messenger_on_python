...
class Ui_Server(object):
    def setupUi(self, MainWindow,):
        ...
        self.pushButton_back_main_page_crt_usr.setGeometry(QtCore.QRect(600, 310, 103, 36))
        self.pushButton_back_main_page_crt_usr.setObjectName("pushButton_back_main_page_crt_usr")
        self.label_name = QtWidgets.QLabel(self.page_crt_usr)
        self.label_name.setGeometry(QtCore.QRect(330, 100, 66, 19))
        self.label_name.setAlignment(QtCore.Qt.AlignCenter)
        self.label_name.setObjectName("label_name")
        self.lineEdit_name = QtWidgets.QLineEdit(self.page_crt_usr)
        self.lineEdit_name.setGeometry(QtCore.QRect(420, 90, 321, 36))
