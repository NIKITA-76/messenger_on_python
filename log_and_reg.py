...
class Ui_LandP_Reg(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGeometry(QtCore.QRect(130, 258, 279, 20))
        self.label_4.setStyleSheet("color: rgb(158, 158, 158);")
        self.label_4.setText("")
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.lineEdit_3 = QtWidgets.QLineEdit(self.page_2)
        self.lineEdit_3.setGeometry(QtCore.QRect(180, 78, 271, 20))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.label_3 = QtWidgets.QLabel(self.page_2)
        self.label_3.setGeometry(QtCore.QRect(50, 219, 101, 16))
        self.label_3.setStyleSheet("color: rgb(158, 158, 158);")
        self.label_3.setObjectName("label_3")
        self.label_5 = QtWidgets.QLabel(self.page_2)
        self.label_5.setGeometry(QtCore.QRect(81, 80, 47, 13))
        self.label_5.setStyleSheet("color: rgb(158, 158, 158);")
        self.label_5.setObjectName("label_5")
        self.pushButton_3 = QtWidgets.QPushButton(self.page_2)
        self.pushButton_3.setGeometry(QtCore.QRect(132, 290, 81, 31))
        self.pushButton_3.setStyleSheet("color: rgb(158, 158, 158);")
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(180, 219, 271, 20))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.lineEdit_5 = QtWidgets.QLineEdit(self.page_2)
        self.lineEdit_5.setGeometry(QtCore.QRect(180, 163, 271, 20))
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.label_6 = QtWidgets.QLabel(self.page_2)
        self.label_6.setGeometry(QtCore.QRect(79, 166, 47, 13))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "Готово"))
